import { Cell, IStateScreenshot } from '../Cell';
import { max, min } from '../math';
import { IWorldEntity } from '../World';
import { Game } from './Game';

export class GameState {
  private readonly history = new Map<number, EntitiesState>();
  ...
  saveInitialStep() {
    const entities = this.game.tickEntities() as Array<
      IWorldEntity<IStateScreenshot>
    >;
